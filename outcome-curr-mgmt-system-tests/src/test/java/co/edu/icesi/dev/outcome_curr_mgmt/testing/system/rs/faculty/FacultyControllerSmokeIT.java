...
public class FacultyControllerSmokeIT extends BaseSmokeIT {
    ...
    //new test: Enviar un FacultyInDTO con campos vacíos o nulos
    @Test
    void createFacultyWithInvalidDataWillFail() {
        FacultyInDTO invalidFaculty = FacultyInDTO.builder()
                .isActive("") // Campo vacío
                .facNameEng("") // Campo vacío
                .facNameSpa("") // Campo vacío
                .build();
        ...
        HttpEntity<FacultyInDTO> requestEntity = new HttpEntity<>(invalidFaculty, headers);
        ResponseEntity<FacultyOutDTO> response = testRestTemplate.exchange(server + OUTCURRAPI_V_1_AUTH_FACULTIES, HttpMethod.POST,
                requestEntity, new ParameterizedTypeReference<FacultyOutDTO>() {});
